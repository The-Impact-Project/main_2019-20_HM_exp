...
The following set of tables breaks the survey respondents down into three equal sized groups based on scores from the TIP persuasion model. These tables are unweighted, and represent survey respondents, _not_ the entire population from the voterfile. That can be added later to replace these tables.
